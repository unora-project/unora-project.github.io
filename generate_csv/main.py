...
Path('csv/armor_monk_f.csv').replace('../docs/equipment/csv/armor/monk/female/armor.csv')
Path('csv/armor_monk_m.csv').replace('../docs/equipment/csv/armor/monk/male/armor.csv')
Path('csv/armor_peasant_f.csv').replace('../docs/equipment/csv/armor/peasant/female/armor.csv')
Path('csv/armor_peasant_m.csv').replace('../docs/equipment/csv/armor/peasant/male/armor.csv')
Path('csv/armor_priest_f.csv').replace('../docs/equipment/csv/armor/priest/female/armor.csv')
Path('csv/armor_priest_m.csv').replace('../docs/equipment/csv/armor/priest/male/armor.csv')
Path('csv/armor_rogue_f.csv').replace('../docs/equipment/csv/armor/rogue/female/armor.csv')
Path('csv/armor_rogue_m.csv').replace('../docs/equipment/csv/armor/rogue/male/armor.csv')
Path('csv/armor_warrior_f.csv').replace('../docs/equipment/csv/armor/warrior/female/armor.csv')
Path('csv/armor_warrior_m.csv').replace('../docs/equipment/csv/armor/warrior/male/armor.csv')
Path('csv/armor_wizard_f.csv').replace('../docs/equipment/csv/armor/wizard/female/armor.csv')
Path('csv/armor_wizard_m.csv').replace('../docs/equipment/csv/armor/wizard/male/armor.csv')
